...
int main()
{
    ...
    if(sift->RunSIFT("E:/Project/ThirdPartyLib/SiftGPU/data/800-1.jpg"))
    {
    ...
    if(sift->RunSIFT("E:/Project/ThirdPartyLib/SiftGPU/data/640-1.jpg"))
    {
